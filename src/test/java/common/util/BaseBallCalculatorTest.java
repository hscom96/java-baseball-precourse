...
class BaseBallCalculatorTest {
    ...
    @Test
    void 스트라이크1_볼1(){
        BaseBallScore score = BaseBallCalculator.getScore("123", "135");
    ...
    @Test
    void 스트라이크2(){
        BaseBallScore score = BaseBallCalculator.getScore("123", "125");
    ...
    @Test
    void 볼2(){
        BaseBallScore score = BaseBallCalculator.getScore("123", "315");
